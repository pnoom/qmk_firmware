 ...
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |CapsLk|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |Minus |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |TogLOW| LAlt |HldMOU| /Space, /       \Space,\  |TogMOU|Ctrl  | Ins  |
 *                   |      |      |      |/TmpLOW /         \TmpLOW\ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 [_QWERTY] = LAYOUT(
  ...
  KC_CAPS, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_MINUS,
            TG(_LOWER), OSM(MOD_LALT), MO(_MOUSE), MODTAPTMP, MODTAPTMP, TG(_MOUSE), OSM(MOD_LCTL), KC_INSERT
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  _______, S(KC_QUOTE), KC_NONUS_BACKSLASH, _______, _______, _______,            KC_NONUS_HASH, _______, _______, _______, _______, _______,
