 ...
 */
 [_QWERTY] = LAYOUT(
  ...
  KC_CAPS, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  TO(_LOWER),
            KC_NONUS_BACKSLASH, OSM(MOD_LALT), MO(_MOUSE), MODTAPTMP(_LOWER, KC_SPC), MODTAPTMP(_LOWER, KC_SPC), TO(_MOUSE), OSM(MOD_LCTL), KC_INSERT
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
